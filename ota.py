...
class OTAUpdater:
    ...
    def __init__(self, ssid, password, repo_url, filename):
        ...
        self.version_url = self.repo_url + 'main/version.json?' + f'token={int(time.time())}''
...
#         my_dict = {data[i]: data[i + 1] for i in range(0, len(data), 2)}
    ...
    def download_and_install_update_if_available(self):
        ...
        print("Repo : " + self.repo_url)
        print("Version : " + self.version_url)
        print("Firmware : " + self.firmware_url)
